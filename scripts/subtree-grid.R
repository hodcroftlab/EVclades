...
axis(side=1, at=1:lenS-0.5, label=paste("H", 1:lenS, sep=""), 
     cex.axis=0.8, las=2)
axis(side=2, at=0:(lenS-1)-0.5, label=si, las=2, cex.axis=0.8)
axis(side=4, at=0:(lenS-1)-0.5, 
